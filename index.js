...
// setiap kali kamu update, buyer HARUS ganti ini → atau kamu buat otomatis
...
async function checkUpdate() {
  try {
    ...
    if (latestVersion !== CURRENT_VERSION) {
      ...
      console.log("✅ Script berhasil diupdate! Restart bot...");
      process.exit(); // restart agar update aktif
    } else {
...
Klik tombol di bawah untuk membeli.
    ...
    await ctx.reply(caption, {
      reply_markup: {
        inline_keyboard: [
          [{ text: "💬 Hubungi Developer", url: "https://instagram.com/itsInaev" }],
          [{ text: "📂 Lihat Fitur Lengkap", url: "https://instagram.com/itsInaev" }],
        ]
      }
    });
